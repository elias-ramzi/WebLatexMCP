  ...
  server.registerTool(
    'set_rewrite_mode',
    {
      ...
      description:
        ...
        'outright, no trace of the original kept (the built-in default — nothing is preserved ' +
        'unless you turn it on). "always": comment the original out above the replacement, the way ' +
